/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: bb2dbdb406d8bb300ca7d693ef7ebaf1)
// Runtime types generated with workerd@1.20260625.1 2026-06-28 nodejs_compat
interface __BaseEnv_Env {
	DATABASE_MAX_REQUEST_BYTES: "4194304";
	DATABASE_DURABLE_OBJECT: DurableObjectNamespace<import("./CloudflareDatabaseWorker").CloudflareDatabaseHost>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./CloudflareDatabaseWorker");
		durableNamespaces: "CloudflareDatabaseHost";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_MAX_REQUEST_BYTES">> {}
}
